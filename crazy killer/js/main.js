        ...
        if (selected != undefined){
            ...
            if (selected.classList.contains("s_s")){
                ...
                if (top_left == true || top_right == true || bottom_left == true || bottom_right == true) {
                    if ( !( (moveable != places || turn_player == "player_1" && if_any_on_key(player_2_key, player_2) == true || turn_player == "player_2" && if_any_on_key(player_1_key, player_1) == true) && offset_top_center == offset_top && offset_left_center == offset_left) ){
                ...
                if ( !( (moveable != places || turn_player == "player_1" && if_any_on_key(player_2_key, player_2) == true || turn_player == "player_2" && if_any_on_key(player_1_key, player_1) == true) && offset_top_center == offset_top && offset_left_center == offset_left) ){
                    ...
                    if(if_in_corner() == true){
                        if (top == true && (is_any("top_left") == true || is_any("top_right") == true) || bottom == true && (is_any("bottom_left") == true || is_any("bottom_right") == true) || left == true && (is_any("top_left") == true || is_any("bottom_left") == true) || right == true && (is_any("top_right") == true || is_any("bottom_right") == true) || top_top_left == true && is_any("top_left") == true || top_top_right == true && is_any("top_right") == true || bottom_bottom_left == true && is_any("bottom_left") == true || bottom_bottom_right == true && is_any("bottom_right") == true || left_left_top == true && is_any("top_left") == true || left_left_bottom == true && is_any("bottom_left") == true || right_right_top == true && is_any("top_right") == true || right_right_bottom == true && is_any("bottom_right") == true || top_left == true || top_left_top_left == true && is_any("top_left") == true || top_right == true || top_right_top_right == true && is_any("top_right") == true || bottom_left == true || bottom_left_bottom_left == true && is_any("bottom_left") == true || bottom_right == true || bottom_right_bottom_right == true && is_any("bottom_right") == true ) {
...
function player_key(path, offset_top_center, offset_left_center) {
    if (turn_player == "player_1" && (path == player_1_key || path.classList.contains("player_2") && if_any_on_key(player_1_key, player_2) == true)) {
    ...
    else if (turn_player == "player_2" && (path == player_2_key || path.classList.contains("player_1") && if_any_on_key(player_2_key, player_1) == true)) {
...
function if_in_corner() {
    ...
    if (selected != undefined){
        ...
        corner_places.forEach(function(elem, indx){
            ...
            if (offset_top == offset_top_selected && offset_left == offset_left_selected) {
                condition = true;
            };
        });
    };

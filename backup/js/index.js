...
const engeneUpdaterBtn = document.querySelector("#engene-update");
const engeneUpdateShower = document.querySelector("#engene-update-show");
...
const engeneUpdatePoints = [25, 35];
const gearUpdatePoints = [15, 25];
const nitroUpdatePoints = [20, 30];
const engeneUpdateincrease = [30, 20];
...
const resate = function () {
  ...
  engeneUpdaterBtn.classList.remove("max");
  gearUpdaterBtn.classList.remove("max");
  nitroUpdaterBtn.classList.remove("max");
  engeneUpdateShower.textContent = "1 / (25 points)";
...
const maxUpdateChecker = function (con, updateThing) {
  if (con) {
    if (updateThing === "engeneUpdate") {
      engeneUpdaterBtn.classList.add("max");
...
const turner = function (point) {
  if (turn === player1.name) {
    ...
    updateChecker(player2, "engeneUpdate", engeneUpdatePoints, engeneUpdateShower);
    ...
    updateChecker(player1, "engeneUpdate", engeneUpdatePoints, engeneUpdateShower);
...
engeneUpdaterBtn.addEventListener("click", function () {
  if (turn === player1.name) {
    updater(player1, ["engeneUpdate", "carSpeed"], engeneUpdateincrease, engeneUpdatePoints, engeneUpdateShower);
  } else if (turn === player2.name) {
    updater(player2, ["engeneUpdate", "carSpeed"], engeneUpdateincrease, engeneUpdatePoints, engeneUpdateShower);
  }
});
